...
const Reviews = () => {
  return (
    <div
      id="reviews"
      className="flex flex-col justify-center items-center h-full w-full min-h-[100vh] p-6 pt-[75px] text-slate-700 dark:bg-slate-900"
    >
      ...
      <div className="w-full py-6 md:px-10 lg:px-16 flex flex-wrap justify-center items-center gap-8">
        {reviews.map((review, index) => (
          ...
          >
            ...
            <div className="flex flex-col justify-between items-start p-4 gap-4 dark:text-slate-400">
